...
import com.thomaspamal.sessionsbeans.ProductosFacadeLocal;
...
public class ProductosController implements Serializable {
    ...
    protected void initializeEmbeddableKey() {
        selected.setProductosPK(new com.thomaspamal.entities.ProductosPK());
    }
    ...
    public Productos getProductos(com.thomaspamal.entities.ProductosPK id) {
    ...
    public static class ProductosControllerConverter implements Converter {
        ...
        com.thomaspamal.entities.ProductosPK getKey(String value) {
            com.thomaspamal.entities.ProductosPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.thomaspamal.entities.ProductosPK();
            key.setIdmenu(Integer.parseInt(values[0]));
            key.setFacturaIdfactura(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(com.thomaspamal.entities.ProductosPK value) {
