...
import com.thomaspamal.sessionsbeans.MeserosFacadeLocal;
...
public class MeserosController implements Serializable {
    ...
    protected void initializeEmbeddableKey() {
        selected.setMeserosPK(new com.thomaspamal.entities.MeserosPK());
    }
    ...
    public Meseros getMeseros(com.thomaspamal.entities.MeserosPK id) {
    ...
    public static class MeserosControllerConverter implements Converter {
        ...
        com.thomaspamal.entities.MeserosPK getKey(String value) {
            com.thomaspamal.entities.MeserosPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.thomaspamal.entities.MeserosPK();
            key.setIdmeseros(Integer.parseInt(values[0]));
            key.setSucursalIdubicacion(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(com.thomaspamal.entities.MeserosPK value) {
            StringBuilder sb = new StringBuilder();
            sb.append(value.getIdmeseros());
            sb.append(SEPARATOR);
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Meseros) {
                ...
                return getStringKey(o.getMeserosPK());
            } else {
